...
test = {   'name': 'q6.2',
    'points': 2,
    'suites': [   {   'cases': [   {   'code': '>>> def test_q6_2_public_1(numpy, f1_train_lr_best_config_fbow, f1_val_lr_best_config_fbow, f1_test_lr_best_config_fbow, best_C, best_max_iter):\n'
