...
test = {   'name': 'q1.3',
    'points': 2,
    'suites': [   {   'cases': [   {   'code': '>>> def test_q1_3_public_1(numpy, binary_bow_train_data, binary_bow_val_data, binary_bow_test_data):\n'
                                       ...
                                       'locked': False,
                                       'points': 0.5},
                                   {   'code': '>>> def test_q1_3_public_2(numpy, to_test):\n'
