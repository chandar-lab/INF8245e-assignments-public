...
test = {   'name': 'q2.1',
    'points': 3,
    'suites': [   {   'cases': [   {   'code': '>>> def test_q2_1_public_1(frequency_bow_train_data, frequency_bow_val_data, frequency_bow_test_data):\n'
                                       ...
                                       'locked': False,
                                       'points': 0.5},
                                   {   'code': '>>> def test_q2_1_public_2(to_test, vocab):\n'
                                       ...
                                       'locked': False,
                                       'points': 0.5},
                                   {   'code': '>>> def test_q2_1_public_3(to_test):\n'
                                               '...     numpy.testing.assert_allclose(to_test.shape == (1, 1000), 1)\n'
